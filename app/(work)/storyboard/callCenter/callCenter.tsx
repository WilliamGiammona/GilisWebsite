...
import PageOne from "../../../../public/images/storyboard/call-center/CallCenter1.png";
import PageTwo from "../../../../public/images/storyboard/call-center/CallCenter2.png";
  ...
  return (
    <>
      <div onClick={() => setIsOpen(true)} className="cursor-pointer">
        ...
        <p className="text-[#b0b0b0] text-left font-thin mt-4">Call Center</p>
      </div>
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        ...
        >
          <DialogTitle className="sr-only">Call Center Gallery</DialogTitle>
