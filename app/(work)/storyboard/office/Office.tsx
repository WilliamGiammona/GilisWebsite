...
import PageOne from "../../../../public/images/storyboard/office/TheOffice1.jpg";
import PageTwo from "../../../../public/images/storyboard/office/TheOffice2.jpg";
import PageThree from "../../../../public/images/storyboard/office/TheOffice3.jpg";
  ...
  return (
    <>
      <div onClick={() => setIsOpen(true)} className="cursor-pointer">
        ...
        <p className="text-[#b0b0b0] text-left font-thin mt-4">The Office</p>
      </div>
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        ...
        >
          <DialogTitle className="sr-only">The Office Gallery</DialogTitle>
