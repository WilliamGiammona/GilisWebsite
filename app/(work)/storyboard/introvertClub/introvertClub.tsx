...
import PageOne from "../../../../public/images/storyboard/introvert-club/ComingSoon.png";
  ...
  return (
    <>
      <div onClick={() => setShowCarousel(true)} className="cursor-pointer">
        <figure className="h-[150px] md:h-[350px] lg:h-[400px]  flex  relative">
          <Image
            src={PageOne}
        ...
        <p className="text-[#b0b0b0] text-center mt-4"></p>
      </div>
